...
let isPanelMinimized = false; // 添加这行
    // 禁用浏览器默认的鼠标中键行为
...
header.appendChild(minimizeButton);
    ...
    // Click point setting functionality
    ...
    function updateClickPointsDisplay() {
        ...
        clickPoints.forEach((point, index) => {
            ...
            if (point.relativeX !== null) {
                ...
                coordsDisplay.textContent = `X: ${Math.round(point.relativeX * 100)}%, Y: ${Math.round(point.relativeY * 100)}%`;
